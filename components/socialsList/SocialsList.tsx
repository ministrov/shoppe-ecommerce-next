...
// Кастомная иконка LinkedIn, так как LinkedinIcon из lucide-react deprecated
 ...
 * Иконка LinkedIn реализована как inline SVG компонент (решение проблемы с устаревшей LinkedinIcon).
