...
/**
 * Кастомная иконка LinkedIn.
 * Используется вместо deprecated LinkedinIcon из библиотеки lucide-react.
 * Поддерживает изменение размера через проп `size` и наследование цвета через currentColor.
 *
 * @param {Object} props - Пропсы компонента
 * @param {number} [props.size=20] - Размер иконки в пикселях
 * @returns {JSX.Element} SVG элемент иконки LinkedIn
 */
export const LinkedinIcon = ({ size = 20, ...rest }: ComponentPropsWithoutRef<'svg'> & { size?: number }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 19 18"
